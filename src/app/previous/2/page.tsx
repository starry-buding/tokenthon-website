      ...
      <main className="flex flex-1 flex-col">
        <div className="flex-1 rounded-t-[2rem] bg-slate-50 px-6 py-14 text-slate-800 md:px-10 md:py-20 lg:px-16">
          <div className="mx-auto max-w-3xl space-y-6">
            <div>
              <p className="text-lg font-medium uppercase tracking-wider text-brand">
                Tokenthon Global Event - Two
              </p>
              <h1 className="text-3xl font-black leading-tight tracking-tight text-brand">
                Unlocking the New Era of the Token Economy
              </h1>
              <p className="whitespace-pre-line text-base leading-relaxed md:text-lg mt-4 text-slate-700">
                Organizer: AlloyX Group
              </p>
              <p className="whitespace-pre-line text-base leading-relaxed md:text-lg text-slate-700">
                Date & Time: April 1, 2026 | 16:00-18:00 (Registration begins at
                15:45)
              </p>
              <p className="whitespace-pre-line text-base leading-relaxed md:text-lg text-slate-700">
